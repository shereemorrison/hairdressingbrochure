...
const DEFAULT_GLOW_COLOR = "191, 155, 48"
...
const createParticleElement = (x: number, y: number, color: string = DEFAULT_GLOW_COLOR): HTMLDivElement => {
  ...
  el.style.cssText = `
    ...
    height: 4px;
    border-radius: 50%;
    background: rgba(255, 215, 0, 1); // Gold particles
    box-shadow: 0 0 6px rgba(255, 215, 0, 0.6); // Gold glow
    pointer-events: none;
    z-index: 100;
    left: ${x}px;
    top: ${y}px;
